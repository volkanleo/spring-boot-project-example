package volkanozturk.examples.springbootprojectexample.controller;

import volkanozturk.examples.springbootprojectexample.annotation.ApiLogger;
...
public class CustomerController {
   ...
   *
   * @param customer object that is going to be created. Please, see the {@link Customer} class for details.
   ...
   * Details related to API specs can be found in the API Documentation which can be reached as described in README file.
   *
   * @return List of CustomerRef Object within ResponseEntity. Please, see the {@link CustomerRef} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   */
   ...
   * @return Customer Object within ResponseEntity. Please, see the {@link Customer} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   */
   ...
   * @param customer is the new object that is going to be patched within the existing one. Please, see the {@link Customer} class for details.
   * @return Customer Object within ResponseEntity. Please, see the {@link Customer} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   ...
   * @param customer is the new object that is going to be put instead of the existing one. Please, see the {@link Customer} class for details.
   * @return Customer Object within ResponseEntity. Please, see the {@link Customer} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
