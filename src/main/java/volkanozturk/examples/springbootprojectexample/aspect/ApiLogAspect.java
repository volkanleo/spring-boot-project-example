package volkanozturk.examples.springbootprojectexample.aspect;
...
import volkanozturk.examples.springbootprojectexample.mapper.ApiLogMapper;
import volkanozturk.examples.springbootprojectexample.mapper.CustomObjectMapper;
import volkanozturk.examples.springbootprojectexample.repository.ApiLogRepository;
import volkanozturk.examples.springbootprojectexample.utility.CommonUtility;
...
public class ApiLogAspect {
   ...
   * @return ApiLog object that is generated. Please, see the {@link ApiLog} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   */
