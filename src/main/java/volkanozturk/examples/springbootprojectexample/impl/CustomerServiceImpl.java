package volkanozturk.examples.springbootprojectexample.impl;
...
import volkanozturk.examples.springbootprojectexample.mapper.CustomerMapper;
import volkanozturk.examples.springbootprojectexample.repository.CustomerRepository;
import volkanozturk.examples.springbootprojectexample.service.ICustomerService;
...
/**
 * Customer Service Implementation class implementing {@link ICustomerService} interface class.
 *
...
public class CustomerServiceImpl implements ICustomerService {
   ...
   *
   * @param customer customer to be created. Please, see the {@link Customer} class for details.
   * @return Customer. Please, see the {@link Customer} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   */
   ...
   *
   * @return List<CustomerRef>. Please, see the {@link CustomerRef} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   */
   ...
   * @param customer customer instance to be updated. Please, see the {@link Customer} class for details.
   * @return Customer. Please, see the {@link Customer} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
  ...
  /**
   *
   * @param customer object that is going to be saved in {@link CustomerRepository}. Please, see the {@link Customer} class for details.
   * @return Customer object. Please, see the {@link Customer} class for details.
   *
   * @author <a href="https://github.com/volkanozturk">Volkan Ozturk</a>
   * @since 1.0.0
   */
